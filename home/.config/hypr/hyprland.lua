...
local menu = "rofi -dpi 1 -show drun"
local run = "rofi -dpi 1 -show run"
...
-- Monitors
hl.bind(mainMod .. " + W", hl.dsp.focus({ monitor = "l" }))
hl.bind(mainMod .. " + SHIFT + W", hl.dsp.window.move({ monitor = "l", follow = false }))
hl.bind(mainMod .. " + E", hl.dsp.focus({ monitor = "r" }))
hl.bind(mainMod .. " + SHIFT + E", hl.dsp.window.move({ monitor = "r", follow = false }))
...
hl.bind(mainMod .. " + SHIFT + comma", hl.dsp.window.resize({ x = 0, y = -10, relative = true }), { repeating = true })
hl.bind(mainMod .. " + SHIFT + period", hl.dsp.window.resize({ x = 0, y = 10, relative = true }), { repeating = true })
...
-- Requires playerctl
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd(playerctl .. " volume 0.05+"), { locked = true, repeating = true })
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd(playerctl .. " volume 0.05-"), { locked = true, repeating = true })
...
hl.window_rule({
  name = "float-windows",
  match = { class = "solaar|org.pulseaudio.pavucontrol|Nsxiv|Sxiv" },
  float = true,
})
